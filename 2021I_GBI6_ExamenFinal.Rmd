...
```{tex}
# Se obtuvo 8 diferentes genes que se expresaron en el cancer de mama, nos muestra que la media fue mayor, es decir, se expreso de mayor forma en los genes dataset con 3,12, seguido de MUC1 con 1,74. 
...
```{tex}
# Figura boxplot3: el nivel de expresion de LUSC ES DE 0,7. Figura regresion: el nivel de expresion para FN1, atraviesa por el -2 y en esta zona se concentran la mayor parte de los puntos, es decir es menos disperso. 
